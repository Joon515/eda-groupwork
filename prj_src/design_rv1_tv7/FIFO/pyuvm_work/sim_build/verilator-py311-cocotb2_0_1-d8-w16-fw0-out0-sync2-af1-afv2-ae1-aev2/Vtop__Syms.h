...
class alignas(VL_CACHE_LINE_BYTES) Vtop__Syms final : public VerilatedSyms {
  public:
    ...
    VerilatedScope* __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty;
    VerilatedScope* __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty__unnamedblk1;
    ...
    VerilatedScope* __Vscopep_async_fifo_top__u_write_pointer__g_almost_full;
    VerilatedScope* __Vscopep_async_fifo_top__u_write_pointer__g_almost_full__unnamedblk1;
