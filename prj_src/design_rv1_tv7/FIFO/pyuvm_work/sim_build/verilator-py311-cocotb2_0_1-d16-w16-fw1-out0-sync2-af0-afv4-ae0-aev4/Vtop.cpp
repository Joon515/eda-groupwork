...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , wclk{vlSymsp->TOP.wclk}
    , wrst{vlSymsp->TOP.wrst}
    , rclk{vlSymsp->TOP.rclk}
    , rrst{vlSymsp->TOP.rrst}
    , winc{vlSymsp->TOP.winc}
    , wfull{vlSymsp->TOP.wfull}
    , walmost_full{vlSymsp->TOP.walmost_full}
    , rinc{vlSymsp->TOP.rinc}
    , rempty{vlSymsp->TOP.rempty}
    , ralmost_empty{vlSymsp->TOP.ralmost_empty}
...
VL_ATTR_COLD void Vtop::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    stfp->spTrace()->addInitCb(&trace_init, &(vlSymsp->TOP), name(), false, 101);
