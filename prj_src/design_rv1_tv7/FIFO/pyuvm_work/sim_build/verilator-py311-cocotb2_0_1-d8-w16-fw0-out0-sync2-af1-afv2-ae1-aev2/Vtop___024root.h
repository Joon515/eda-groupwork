...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final {
  public:
    ...
    struct {
        ...
        CData/*3:0*/ async_fifo_top__DOT__u_write_pointer__DOT__g_almost_full__DOT__rbin_sync;
        CData/*3:0*/ async_fifo_top__DOT__u_write_pointer__DOT__g_almost_full__DOT__wcount;
        CData/*0:0*/ async_fifo_top__DOT__u_write_pointer__DOT__g_almost_full__DOT__walmost_full_val;
    ...
    struct {
        ...
        CData/*3:0*/ async_fifo_top__DOT__u_read_pointer__DOT__g_almost_empty__DOT__wbin_sync;
        CData/*3:0*/ async_fifo_top__DOT__u_read_pointer__DOT__g_almost_empty__DOT__rcount;
        CData/*0:0*/ async_fifo_top__DOT__u_read_pointer__DOT__g_almost_empty__DOT__ralmost_empty_val;
        ...
        IData/*31:0*/ async_fifo_top__DOT__u_write_pointer__DOT__g_almost_full__DOT__unnamedblk1__DOT__i;
        IData/*31:0*/ async_fifo_top__DOT__u_read_pointer__DOT__g_almost_empty__DOT__unnamedblk1__DOT__i;
    ...
    static constexpr CData/*0:0*/ async_fifo_top__DOT__ALMOST_FULL_EN = 1U;
    static constexpr CData/*0:0*/ async_fifo_top__DOT__ALMOST_EMPTY_EN = 1U;
    ...
    static constexpr CData/*0:0*/ async_fifo_top__DOT__u_write_pointer__DOT__ALMOST_FULL_EN = 1U;
    ...
    static constexpr CData/*0:0*/ async_fifo_top__DOT__u_read_pointer__DOT__ALMOST_EMPTY_EN = 1U;
    ...
    static constexpr IData/*31:0*/ async_fifo_top__DOT__ALMOST_FULL_VAL = 2U;
    static constexpr IData/*31:0*/ async_fifo_top__DOT__ALMOST_EMPTY_VAL = 2U;
    ...
    static constexpr IData/*31:0*/ async_fifo_top__DOT__u_write_pointer__DOT__ALMOST_FULL_VAL = 2U;
    ...
    static constexpr IData/*31:0*/ async_fifo_top__DOT__u_read_pointer__DOT__ALMOST_EMPTY_VAL = 2U;
