...
VL_ATTR_COLD void Vtop___024root___eval_initial__TOP(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.async_fifo_top__DOT__u_write_pointer__DOT__walmost_full = 0U;
    vlSelfRef.async_fifo_top__DOT__u_read_pointer__DOT__ralmost_empty = 0U;
    vlSelfRef.walmost_full = 0U;
    vlSelfRef.async_fifo_top__DOT__walmost_full = 0U;
    vlSelfRef.ralmost_empty = 0U;
    vlSelfRef.async_fifo_top__DOT__ralmost_empty = 0U;
}
...
VL_ATTR_COLD void Vtop___024root___stl_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.async_fifo_top__DOT__rinc_internal = 
        ((~ (IData)(vlSelfRef.async_fifo_top__DOT__rempty_raw)) 
         & (IData)(vlSelfRef.async_fifo_top__DOT__rinc));
    ...
    vlSelfRef.async_fifo_top__DOT__u_write_pointer__DOT__wbin_next 
        = (0x0000001fU & ((IData)(vlSelfRef.async_fifo_top__DOT__u_write_pointer__DOT__wbin) 
    ...
    vlSelfRef.async_fifo_top__DOT__u_write_pointer__DOT__wgray_next 
        = (VL_SHIFTR_III(5,5,32, (IData)(vlSelfRef.async_fifo_top__DOT__u_write_pointer__DOT__wbin_next), 1U) 
    ...
    vlSelfRef.async_fifo_top__DOT__u_read_pointer__DOT__rbin_next 
        = (0x0000001fU & ((IData)(vlSelfRef.async_fifo_top__DOT__u_read_pointer__DOT__rbin) 
    ...
    vlSelfRef.async_fifo_top__DOT__u_write_pointer__DOT__wfull_val 
        = ((IData)(vlSelfRef.async_fifo_top__DOT__u_write_pointer__DOT__wgray_next) 
           == ((0x00000018U & ((~ ((IData)(vlSelfRef.async_fifo_top__DOT__u_write_pointer__DOT__rgray_sync) 
                                   >> 3U)) << 3U)) 
               | (7U & (IData)(vlSelfRef.async_fifo_top__DOT__u_write_pointer__DOT__rgray_sync))));
    ...
    vlSelfRef.async_fifo_top__DOT__u_read_pointer__DOT__rgray_next 
        = (VL_SHIFTR_III(5,5,32, (IData)(vlSelfRef.async_fifo_top__DOT__u_read_pointer__DOT__rbin_next), 1U) 
...
VL_ATTR_COLD void Vtop___024root___dump_triggers__act(const VlUnpacked<QData/*63:0*/, 1> &triggers, const std::string &tag) {
    ...
    if ((1U & (IData)(triggers[0U]))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 0 is active: @(posedge async_fifo_top.u_sync_r2w.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 1U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 1 is active: @(posedge async_fifo_top.u_sync_r2w.rst_cond)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 2U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 2 is active: @(posedge async_fifo_top.u_sync_w2r.clk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 3U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 3 is active: @(posedge async_fifo_top.u_sync_w2r.rst_cond)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 4U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 4 is active: @(posedge async_fifo_top.u_write_pointer.rst_cond)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 5U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 5 is active: @(posedge async_fifo_top.u_write_pointer.wclk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 6U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 6 is active: @(posedge async_fifo_top.u_read_pointer.rclk)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 7U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 7 is active: @(posedge async_fifo_top.u_read_pointer.rst_cond)\n");
    }
    if ((1U & (IData)((triggers[0U] >> 8U)))) {
        VL_DBG_MSGS("         '" + tag + "' region trigger index 8 is active: @(posedge async_fifo_top.u_dual_port_ram.wclk)\n");
    }
}
#endif  // VL_DEBUG
...
VL_ATTR_COLD void Vtop___024root___ctor_var_reset(Vtop___024root* vlSelf) {
    ...
    vlSelf->async_fifo_top__DOT__walmost_full = 0U;
    ;
    ...
    vlSelf->async_fifo_top__DOT__ralmost_empty = 0U;
    ;
    ...
    vlSelf->async_fifo_top__DOT__wptr_gray = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 4913745089053382027ull);
    vlSelf->async_fifo_top__DOT__rptr_gray = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 10492970134993014866ull);
    vlSelf->async_fifo_top__DOT__rptr_gray_sync_w2 = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 5248458549028985464ull);
    vlSelf->async_fifo_top__DOT__wptr_gray_sync_r2 = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 10001797989778344212ull);
    vlSelf->async_fifo_top__DOT__waddr = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 2907359564356130297ull);
    vlSelf->async_fifo_top__DOT__raddr = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 10206627934347838097ull);
    ...
    vlSelf->async_fifo_top__DOT__u_sync_r2w__DOT__din = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 8362619265171917639ull);
    vlSelf->async_fifo_top__DOT__u_sync_r2w__DOT__dout = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 7495756251000434164ull);
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->async_fifo_top__DOT__u_sync_r2w__DOT__sync_reg[__Vi0] = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 11079977675207378519ull);
    }
    ...
    vlSelf->async_fifo_top__DOT__u_sync_w2r__DOT__din = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 16283387964365527597ull);
    vlSelf->async_fifo_top__DOT__u_sync_w2r__DOT__dout = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 14105793841632721822ull);
    for (int __Vi0 = 0; __Vi0 < 2; ++__Vi0) {
        vlSelf->async_fifo_top__DOT__u_sync_w2r__DOT__sync_reg[__Vi0] = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 15220620453709799988ull);
    }
    ...
    vlSelf->async_fifo_top__DOT__u_write_pointer__DOT__rgray_sync = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 1319912999036734091ull);
    vlSelf->async_fifo_top__DOT__u_write_pointer__DOT__waddr = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 17861497615370581064ull);
    vlSelf->async_fifo_top__DOT__u_write_pointer__DOT__wgray = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 17407014056604179372ull);
    vlSelf->async_fifo_top__DOT__u_write_pointer__DOT__wfull = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 17546922436562926477ull);
    vlSelf->async_fifo_top__DOT__u_write_pointer__DOT__walmost_full = 0U;
    ;
    vlSelf->async_fifo_top__DOT__u_write_pointer__DOT__wbin = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 7132384648907871864ull);
    vlSelf->async_fifo_top__DOT__u_write_pointer__DOT__wbin_next = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 5211930558626041574ull);
    vlSelf->async_fifo_top__DOT__u_write_pointer__DOT__wgray_next = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 14190278208104883585ull);
    ...
    vlSelf->async_fifo_top__DOT__u_read_pointer__DOT__wgray_sync = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 3998669145285028093ull);
    vlSelf->async_fifo_top__DOT__u_read_pointer__DOT__raddr = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 17644612342026274628ull);
    vlSelf->async_fifo_top__DOT__u_read_pointer__DOT__rgray = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 8774427142916064364ull);
    vlSelf->async_fifo_top__DOT__u_read_pointer__DOT__rempty = VL_SCOPED_RAND_RESET_I(1, __VscopeHash, 10574613551598626645ull);
    vlSelf->async_fifo_top__DOT__u_read_pointer__DOT__ralmost_empty = 0U;
    ;
    vlSelf->async_fifo_top__DOT__u_read_pointer__DOT__rbin = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 1723618272422517899ull);
    vlSelf->async_fifo_top__DOT__u_read_pointer__DOT__rbin_next = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 10982543007613604815ull);
    vlSelf->async_fifo_top__DOT__u_read_pointer__DOT__rgray_next = VL_SCOPED_RAND_RESET_I(5, __VscopeHash, 9957705584301026622ull);
    ...
    vlSelf->async_fifo_top__DOT__u_dual_port_ram__DOT__waddr = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 9704679280826126584ull);
    vlSelf->async_fifo_top__DOT__u_dual_port_ram__DOT__wdata = VL_SCOPED_RAND_RESET_I(16, __VscopeHash, 11703742115018426268ull);
    vlSelf->async_fifo_top__DOT__u_dual_port_ram__DOT__raddr = VL_SCOPED_RAND_RESET_I(4, __VscopeHash, 9388421617570928365ull);
