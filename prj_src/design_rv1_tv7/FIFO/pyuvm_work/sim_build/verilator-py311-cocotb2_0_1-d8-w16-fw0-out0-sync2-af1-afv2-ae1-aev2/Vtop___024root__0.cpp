...
void Vtop___024root___nba_sequent__TOP__1(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.async_fifo_top__DOT__u_write_pointer__DOT__walmost_full 
        = ((~ (IData)(vlSelfRef.async_fifo_top__DOT__u_write_pointer__DOT__rst_cond)) 
           & (IData)(vlSelfRef.async_fifo_top__DOT__u_write_pointer__DOT__g_almost_full__DOT__walmost_full_val));
...
void Vtop___024root___nba_sequent__TOP__2(Vtop___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.async_fifo_top__DOT__u_read_pointer__DOT__ralmost_empty 
        = ((IData)(vlSelfRef.async_fifo_top__DOT__u_read_pointer__DOT__rst_cond) 
           | (IData)(vlSelfRef.async_fifo_top__DOT__u_read_pointer__DOT__g_almost_empty__DOT__ralmost_empty_val));
