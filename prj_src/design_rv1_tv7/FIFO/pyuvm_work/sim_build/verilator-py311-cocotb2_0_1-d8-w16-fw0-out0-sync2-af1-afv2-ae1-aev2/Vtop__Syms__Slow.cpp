    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty = new VerilatedScope{this, "async_fifo_top.u_read_pointer.g_almost_empty", "g_almost_empty", "<null>", -9, VerilatedScope::SCOPE_OTHER};
    __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty__unnamedblk1 = new VerilatedScope{this, "async_fifo_top.u_read_pointer.g_almost_empty.unnamedblk1", "unnamedblk1", "<null>", -9, VerilatedScope::SCOPE_OTHER};
    ...
    __Vscopep_async_fifo_top__u_write_pointer__g_almost_full = new VerilatedScope{this, "async_fifo_top.u_write_pointer.g_almost_full", "g_almost_full", "<null>", -9, VerilatedScope::SCOPE_OTHER};
    __Vscopep_async_fifo_top__u_write_pointer__g_almost_full__unnamedblk1 = new VerilatedScope{this, "async_fifo_top.u_write_pointer.g_almost_full.unnamedblk1", "unnamedblk1", "<null>", -9, VerilatedScope::SCOPE_OTHER};
    ...
    __Vhier.add(__Vscopep_async_fifo_top__u_read_pointer, __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty);
    __Vhier.add(__Vscopep_async_fifo_top__u_read_pointer__g_almost_empty, __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty__unnamedblk1);
    ...
    __Vhier.add(__Vscopep_async_fifo_top__u_write_pointer, __Vscopep_async_fifo_top__u_write_pointer__g_almost_full);
    __Vhier.add(__Vscopep_async_fifo_top__u_write_pointer__g_almost_full, __Vscopep_async_fifo_top__u_write_pointer__g_almost_full__unnamedblk1);
    ...
    __Vscopep_async_fifo_top->varInsert("raddr", &(TOP.async_fifo_top__DOT__raddr), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,2,0);
    ...
    __Vscopep_async_fifo_top->varInsert("rptr_gray", &(TOP.async_fifo_top__DOT__rptr_gray), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_async_fifo_top->varInsert("rptr_gray_sync_w2", &(TOP.async_fifo_top__DOT__rptr_gray_sync_w2), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    ...
    __Vscopep_async_fifo_top->varInsert("waddr", &(TOP.async_fifo_top__DOT__waddr), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,2,0);
    ...
    __Vscopep_async_fifo_top->varInsert("wptr_gray", &(TOP.async_fifo_top__DOT__wptr_gray), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_async_fifo_top->varInsert("wptr_gray_sync_r2", &(TOP.async_fifo_top__DOT__wptr_gray_sync_r2), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    ...
    __Vscopep_async_fifo_top__u_dual_port_ram->varInsert("mem", &(TOP.async_fifo_top__DOT__u_dual_port_ram__DOT__mem), false, VLVT_UINT16, VLVD_NODIR|VLVF_PUB_RW, 1, 1 ,0,7 ,15,0);
    __Vscopep_async_fifo_top__u_dual_port_ram->varInsert("raddr", &(TOP.async_fifo_top__DOT__u_dual_port_ram__DOT__raddr), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,2,0);
    ...
    __Vscopep_async_fifo_top__u_dual_port_ram->varInsert("waddr", &(TOP.async_fifo_top__DOT__u_dual_port_ram__DOT__waddr), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,2,0);
    ...
    __Vscopep_async_fifo_top__u_read_pointer->varInsert("raddr", &(TOP.async_fifo_top__DOT__u_read_pointer__DOT__raddr), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,2,0);
    ...
    __Vscopep_async_fifo_top__u_read_pointer->varInsert("rbin", &(TOP.async_fifo_top__DOT__u_read_pointer__DOT__rbin), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_async_fifo_top__u_read_pointer->varInsert("rbin_next", &(TOP.async_fifo_top__DOT__u_read_pointer__DOT__rbin_next), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,3,0);
    ...
    __Vscopep_async_fifo_top__u_read_pointer->varInsert("rgray", &(TOP.async_fifo_top__DOT__u_read_pointer__DOT__rgray), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_async_fifo_top__u_read_pointer->varInsert("rgray_next", &(TOP.async_fifo_top__DOT__u_read_pointer__DOT__rgray_next), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,3,0);
    ...
    __Vscopep_async_fifo_top__u_read_pointer->varInsert("wgray_sync", &(TOP.async_fifo_top__DOT__u_read_pointer__DOT__wgray_sync), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty->varInsert("ralmost_empty_val", &(TOP.async_fifo_top__DOT__u_read_pointer__DOT__g_almost_empty__DOT__ralmost_empty_val), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 0);
    __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty->varInsert("rcount", &(TOP.async_fifo_top__DOT__u_read_pointer__DOT__g_almost_empty__DOT__rcount), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,3,0);
    __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty->varInsert("wbin_sync", &(TOP.async_fifo_top__DOT__u_read_pointer__DOT__g_almost_empty__DOT__wbin_sync), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty__unnamedblk1->varInsert("i", &(TOP.async_fifo_top__DOT__u_read_pointer__DOT__g_almost_empty__DOT__unnamedblk1__DOT__i), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW|VLVF_DPI_CLAY|VLVF_SIGNED, 0, 1 ,31,0);
    ...
    __Vscopep_async_fifo_top__u_sync_r2w->varInsert("din", &(TOP.async_fifo_top__DOT__u_sync_r2w__DOT__din), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_async_fifo_top__u_sync_r2w->varInsert("dout", &(TOP.async_fifo_top__DOT__u_sync_r2w__DOT__dout), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,3,0);
    ...
    __Vscopep_async_fifo_top__u_sync_r2w->varInsert("sync_reg", &(TOP.async_fifo_top__DOT__u_sync_r2w__DOT__sync_reg), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 1, 1 ,1,0 ,3,0);
    ...
    __Vscopep_async_fifo_top__u_sync_w2r->varInsert("din", &(TOP.async_fifo_top__DOT__u_sync_w2r__DOT__din), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_async_fifo_top__u_sync_w2r->varInsert("dout", &(TOP.async_fifo_top__DOT__u_sync_w2r__DOT__dout), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,3,0);
    ...
    __Vscopep_async_fifo_top__u_sync_w2r->varInsert("sync_reg", &(TOP.async_fifo_top__DOT__u_sync_w2r__DOT__sync_reg), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 1, 1 ,1,0 ,3,0);
    ...
    __Vscopep_async_fifo_top__u_write_pointer->varInsert("rgray_sync", &(TOP.async_fifo_top__DOT__u_write_pointer__DOT__rgray_sync), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    ...
    __Vscopep_async_fifo_top__u_write_pointer->varInsert("waddr", &(TOP.async_fifo_top__DOT__u_write_pointer__DOT__waddr), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,2,0);
    ...
    __Vscopep_async_fifo_top__u_write_pointer->varInsert("wbin", &(TOP.async_fifo_top__DOT__u_write_pointer__DOT__wbin), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_async_fifo_top__u_write_pointer->varInsert("wbin_next", &(TOP.async_fifo_top__DOT__u_write_pointer__DOT__wbin_next), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,3,0);
    ...
    __Vscopep_async_fifo_top__u_write_pointer->varInsert("wgray", &(TOP.async_fifo_top__DOT__u_write_pointer__DOT__wgray), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_async_fifo_top__u_write_pointer->varInsert("wgray_next", &(TOP.async_fifo_top__DOT__u_write_pointer__DOT__wgray_next), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,3,0);
    ...
    __Vscopep_async_fifo_top__u_write_pointer__g_almost_full->varInsert("rbin_sync", &(TOP.async_fifo_top__DOT__u_write_pointer__DOT__g_almost_full__DOT__rbin_sync), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,3,0);
    __Vscopep_async_fifo_top__u_write_pointer__g_almost_full->varInsert("walmost_full_val", &(TOP.async_fifo_top__DOT__u_write_pointer__DOT__g_almost_full__DOT__walmost_full_val), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 0);
    __Vscopep_async_fifo_top__u_write_pointer__g_almost_full->varInsert("wcount", &(TOP.async_fifo_top__DOT__u_write_pointer__DOT__g_almost_full__DOT__wcount), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW|VLVF_CONTINUOUSLY, 0, 1 ,3,0);
    __Vscopep_async_fifo_top__u_write_pointer__g_almost_full__unnamedblk1->varInsert("i", &(TOP.async_fifo_top__DOT__u_write_pointer__DOT__g_almost_full__DOT__unnamedblk1__DOT__i), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW|VLVF_DPI_CLAY|VLVF_SIGNED, 0, 1 ,31,0);
}
...
Vtop__Syms::~Vtop__Syms() {
    ...
    __Vhier.remove(__Vscopep_async_fifo_top__u_read_pointer, __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty);
    __Vhier.remove(__Vscopep_async_fifo_top__u_read_pointer__g_almost_empty, __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty__unnamedblk1);
    ...
    __Vhier.remove(__Vscopep_async_fifo_top__u_write_pointer, __Vscopep_async_fifo_top__u_write_pointer__g_almost_full);
    __Vhier.remove(__Vscopep_async_fifo_top__u_write_pointer__g_almost_full, __Vscopep_async_fifo_top__u_write_pointer__g_almost_full__unnamedblk1);
    ...
    VL_DO_CLEAR(delete __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty, __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty = nullptr);
    VL_DO_CLEAR(delete __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty__unnamedblk1, __Vscopep_async_fifo_top__u_read_pointer__g_almost_empty__unnamedblk1 = nullptr);
    ...
    VL_DO_CLEAR(delete __Vscopep_async_fifo_top__u_write_pointer__g_almost_full, __Vscopep_async_fifo_top__u_write_pointer__g_almost_full = nullptr);
    VL_DO_CLEAR(delete __Vscopep_async_fifo_top__u_write_pointer__g_almost_full__unnamedblk1, __Vscopep_async_fifo_top__u_write_pointer__g_almost_full__unnamedblk1 = nullptr);
